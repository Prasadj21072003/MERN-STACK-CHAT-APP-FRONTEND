...
const Signup = () => {
  ...
  return (
    <div
      className=" relative  w-[400px] h-[480px] max-sm:h-[570px] bg-gray-500 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100
"
    >
